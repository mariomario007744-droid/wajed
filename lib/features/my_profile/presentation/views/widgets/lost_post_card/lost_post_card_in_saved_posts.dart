...
import 'package:wajed/features/my_profile/presentation/views/widgets/list_post_action_buttons_in_saved_posts.dart';
import 'package:wajed/features/my_profile/presentation/views/widgets/lost_post_card/widgets/lost_post_header_in_saved_posts.dart';

class LostPostCardInSavedPosts extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          ListPostActionButtonsInSavedPosts(),
        ],
      ),
    );
  }
